...
* Data from the *weight* only has 8 participants and data from *heartrate_seconds* only has 14 participants. Without we have missed out on some really great opportunites to draw helpful conclusions.
